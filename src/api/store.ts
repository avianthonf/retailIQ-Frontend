...
export const listCategories = () => request<ListCategoriesResponse>({ url: '/api/v1/store/categories', method: 'GET' });
...
export const updateStoreTaxConfig = (payload: UpdateStoreTaxConfigRequest) => request<UpdateStoreTaxConfigResponse>({ url: '/api/v1/store/tax-config', method: 'PUT', data: payload });
