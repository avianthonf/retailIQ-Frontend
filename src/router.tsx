    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/oauth/authorize', element: suspense(<OAuthAuthorizePage />) },
          { path: '/oauth/callback', element: suspense(<OAuthCallbackPage />) },
        ],
      },
      {
        element: <AuthGuard />,
        children: [
          {
            ...
            children: [
              ...
              { path: '/payments', element: suspense(<PaymentsPage />) },
